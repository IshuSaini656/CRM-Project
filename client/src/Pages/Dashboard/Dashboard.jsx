    ...
    <div className="flex flex-col xl:flex-row gap-4">
      ...
      <div className="w-full xl:w-[70%] flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="bg-zinc-900 border border-zinc-800">
            ...
            <CardContent>
              ...
              <div className="text-green-400 text-sm">+120 last 30 days</div>
            </CardContent>
          </Card>

          <Card className="bg-zinc-900 border border-zinc-800">
            <CardHeader className="flex justify-between">
              <CardTitle className="text-white text-sm">Staff</CardTitle>
          ...
          <Card className="bg-zinc-900 border border-zinc-800">
            <CardHeader className="flex justify-between">
              <CardTitle className="text-white text-sm">Teachers</CardTitle>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <Card className="bg-slate-900 border border-slate-800 w-full lg:w-[40%]">
            <CardHeader>
              <CardTitle className="text-white text-sm">Students</CardTitle>
            </CardHeader>
            ...
            <CardContent className="flex flex-col items-center">
              ...
              <div className="flex gap-4 mt-3 text-sm">
                <span className="flex items-center gap-2 text-blue-400">
                  <div className="w-3 h-3 bg-blue-500 rounded-full"></div>Boys
                </span>
          ...
          <Card className="bg-slate-900 border border-slate-800 w-full lg:w-[60%]">
            <CardHeader>
              <CardTitle className="text-white text-sm">Attendance</CardTitle>
            </CardHeader>
        ...
        <Card className="bg-slate-900 border border-slate-800">
          ...
          <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {demandedCourses.map((course, index) => (
              <div
                key={index}
                className="bg-slate-800 hover:bg-slate-700 p-3 rounded-lg flex justify-between text-sm text-white"
              >
        ...
        {/* GRAPH */}
        <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 md:p-6 h-[320px] md:h-[400px] flex flex-col">
          <h2 className="text-white mb-2 text-base md:text-lg font-semibold">
            Revenue vs Expenses
          </h2>
      ...
      <div className="w-full xl:w-[30%] flex flex-col gap-6">
        <Card className="bg-slate-900 border border-slate-800 w-full">
          <CardHeader>
          ...
          <CardContent className="flex flex-col gap-2">
            {companies.map((c, i) => (
              <div
                key={i}
                className="flex justify-between bg-slate-800 px-3 py-2 rounded text-white text-sm"
              >
                <span>{c}</span>
        ...
        <Card className="bg-slate-900 border border-slate-800 w-full">
          ...
          <CardContent className="flex flex-col gap-2 text-sm text-white">
        ...
        <Card className="bg-slate-900 border border-slate-800 w-full">
          <CardHeader>
            <CardTitle className="text-white text-sm">Average Salary</CardTitle>
          </CardHeader>
        ...
        <Card className="bg-slate-900 border border-slate-800 w-full">
          ...
          <CardContent className="text-center">
            ...
            <p className="text-gray-400 text-sm">Students placed this year</p>
